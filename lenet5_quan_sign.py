...
ADD_CONV_ERROR   = True
MU_PATH = "./conv_error/avg_mu_signed.csv"
SIGMA_PATH = "./conv_error/avg_sigma_signed.csv"
...
class LeNet5(nn.Module):
    ...
    def linear_scale(self, x):
        ...
        min1 = 0
        return torch.clamp((x - min1) / (max1 - min1), -1.0, 1.0)
...
def clip_parameters(model, min_val=-1.0, max_val=1.0):
...
torch.save(model.state_dict(), "lenet5_mnist_quan_sign.pth")
print("Model saved to lenet5_mnist_quan_sign.pth")
